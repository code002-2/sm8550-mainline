...
/* MST stream and payload registers */
#define REG_DP1_CONFIGURATION_CTRL		(0x00000400)
#define REG_DP0_TIMESLOT_1_32			(0x00000404)
#define REG_DP0_TIMESLOT_33_63			(0x00000408)
#define REG_DP1_TIMESLOT_1_32			(0x0000040C)
#define REG_DP1_TIMESLOT_33_63			(0x00000410)
...
#define REG_DP1_VALID_BOUNDARY			(0x00000430)
#define REG_DP1_VALID_BOUNDARY_2			(0x00000434)
#define REG_DP1_TU				(0x0000044C)
#define REG_DP_MST_ACT				(0x00000500)
#define REG_DP_MST_MAINLINK_READY		(0x00000504)
